  ...
  return (
    <main className="container mx-auto px-4 py-12">
      <div className="text-center max-w-3xl mx-auto mb-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-blue-600 via-pink-500 to-purple-600 text-transparent bg-clip-text">
      ...
      <div className="max-w-2xl mx-auto mb-12">
        <div className="relative">
          ...
          />
          <Button className="absolute right-1 top-1 bg-blue-600 hover:bg-blue-700 h-10" onClick={handleShortenLink}>
            Shorten Now!
          </Button>
        </div>
            ...
            {linksData.length > 0 ? (
              linksData.map((item) => (
                <TableRow key={item._id} className="dark:hover:bg-slate-900/50">
                  ...
                  <TableCell className="max-w-xs truncate" title={item.originalLink}>
                    {item.originalLink}
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${item.status === "Active" ? "bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400" : "bg-yellow-100 text-yellow-600 dark:bg-yellow-900/30 dark:text-yellow-400"}`}
                    >
                      {item.status}
                    </span>
                  </TableCell>
